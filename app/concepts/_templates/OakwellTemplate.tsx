...
export default function OakwellTemplate() {
  return (
    <div className="font-sans antialiased selection:bg-white/10 relative z-0" style={{ backgroundColor: oakwellTheme.bgColor, color: oakwellTheme.textColor }}>
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-6 md:px-12 w-full max-w-[1400px] mx-auto">
        {/* Hamburger Menu (Left) */}
        ...
        <div className="flex-1 flex justify-center">
          <div className="flex items-center gap-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-sm border border-white/10">
            <svg className="w-8 h-8" style={{ color: oakwellTheme.accentColor }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
            <div className="flex flex-col">
              <span className="text-white font-playfair text-xl leading-none">Oakwell Dental</span>
              <span className="text-[9px] font-medium tracking-wide" style={{ color: "#2c2a2a" }}>Caring for your smile</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-end gap-4">
          ...
          <a href="#contact" className="text-[#05050a] text-xs font-semibold tracking-widest px-6 py-2.5 rounded-sm hover:opacity-90 transition-opacity" style={{ backgroundColor: oakwellTheme.accentColor }}>
            BOOK ONLINE
          </a>
        </div>
      </nav>
      ...
      >
        ...
        <div className="relative z-10 max-w-[800px] flex flex-col items-center">
          ...
          <h1
            className="text-[42px] md:text-[56px] lg:text-[68px] leading-[1.05] font-playfair font-normal tracking-tight mb-8 text-white/95"
