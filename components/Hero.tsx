  ...
  return (
    <>
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-32 sm:pt-20 pb-32 sm:pb-36 overflow-hidden">
        ...
        <div
          className="absolute inset-x-0 bottom-0 top-16.25 opacity-[0.03]"
          style={{
        ...
        {/* Trust bar */}
        <div className="absolute bottom-0 left-0 right-0 z-10 border-t border-white/12 backdrop-blur-2xl"
